<template>
    <div>
        <div class="hidden md:block text-center mb-4">
            <div class="px-4 py-2 bg-red-400 items-center text-red-100 leading-none lg:rounded-full flex lg:inline-flex"
                 role="alert">
                <span
                    class="text-left flex-auto">KalmKanine is designed for smartphones in portait mode and might not be displayed correctly on larger screens.</span>
            </div>
        </div>
        <div class="mb-4">
                    ...
                    <router-link :to="{name: 'exercise', params: {id: exercise.id}}">
                        ...
                        <div class="inline" v-if="exercise.id < maxId">
                            <svg width="1em" height="1em" viewBox="0 0 16 16"
                                 class="bi bi-check rounded-full bg-yellow-500 inline" fill="currentColor"
